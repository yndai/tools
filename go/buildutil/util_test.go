...
func TestContainingPackage(t *testing.T) {
	...
	exported := packagestest.Export(t, packagestest.GOPATH, []packagestest.Module{
		{Name: "github.com/yndai/tools/go/buildutil", Files: packagestest.MustCopyFileTree(".")}})
	...
	if runtime.GOOS != "windows" && runtime.GOOS != "plan9" {
		...
		tests = append(tests, []Test{
			{gopath, tmp + "/src/golang.org/x/tools/go/buildutil/util_test.go", "github.com/yndai/tools/go/buildutil"},
			{tmp, gopath + "/src/golang.org/x/tools/go/buildutil/util_test.go", "github.com/yndai/tools/go/buildutil"},
			{tmp, tmp + "/src/golang.org/x/tools/go/buildutil/util_test.go", "github.com/yndai/tools/go/buildutil"},
		}...)
	}
